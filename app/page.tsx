      ...
      <div className="relative h-[40vh] flex items-center justify-center overflow-hidden border-b border-red-600/30">
        ...
        <div className="z-20 text-center px-4">
          <h1 className="text-6xl md:text-8xl font-black italic uppercase tracking-tighter leading-none mb-4">
            F1 <span className="text-red-500">MaxToTheMax</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="relative z-10">
              ...
              {nextRace && (
                <Link 
                  ...
                  className="inline-block bg-white text-black font-black italic uppercase px-8 py-4 rounded-xl hover:bg-red-600 hover:text-white transition-all"
                >
                  Voorspellen →
                </Link>
              )}
          ...
          <div className="space-y-6">
            <Link href="/races" className="block group">
              <div className="bg-[#1c232e] border border-slate-700 p-6 rounded-2xl hover:border-red-600 transition-all">
                <h3 className="font-black italic uppercase text-xl group-hover:text-red-500">Volledige Kalender</h3>
            ...
            <Link href="/predictions/season" className="block group">
              <div className="bg-gradient-to-br from-red-900/40 to-red-600/10 border border-red-900/50 p-6 rounded-2xl hover:border-red-500 transition-all">
